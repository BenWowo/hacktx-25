		...
		>
			...
			<header className="px-8 py-6 flex items-center justify-between">
				<div className="flex items-center gap-6">
					<img
						src="/Designer__1_-removebg-preview.png"
						alt="Company Logo"
						className="w-20 h-20 object-contain"
					/>
					<h1 className="text-3xl font-inter font-bold tracking-tighter bg-gradient-to-r from-red-600 to-red-800 bg-clip-text text-transparent">
						Financial Finish
					</h1>
				</div>
				<div className="flex items-center gap-4">
					...
					<Button
						...
						className="bg-black text-white rounded-full px-6 py-6 text-xl transition-colors duration-300 hover:bg-white hover:text-black"
			...
			<div className="relative flex items-center justify-center px-8 py-20 overflow-hidden">
				...
				<div className="relative z-10 max-w-4xl mx-auto text-center pt-12">
					<div className="inline-block backdrop-blur-sm bg-white/20 rounded-3xl p-8">
						<h1 className="text-7xl md:text-8xl mb-6 leading-tight font-inter font-semibold tracking-tighter">
							<span className="text-gray-900">Your journey,</span>
							<br />
							<div className="textRow flex flex-row justify-center gap-2">
								<span className="text-gray-900">begins</span>
								<span className="bg-gradient-to-r from-[#d71920] to-[#a01419] bg-clip-text text-transparent">
									here.
								</span>
							</div>
						</h1>

						<p className="text-[#000000] mb-8 max-w-md mx-auto font-semibold text-lg">
						...
						<div className="flex items-center justify-center gap-4">
							<a
								href="/ui/track"
								className="inline-block bg-black text-white rounded-full px-6 py-6 text-xl text-center transition-colors duration-300 hover:bg-white hover:text-black"
							>
								Get Started
							</a>
						</div>
