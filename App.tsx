...
import CarSelectionPage, { type CarOption } from './components/CarSelectionPage';
...
export default function App() {
  const [currentStep, setCurrentStep] = useState<'home' | 'form' | 'loading' | 'carSelection' | 'loadingPayment' | 'results' | 'analysis'>('home');
  ...
  const [selectedPaymentOption, setSelectedPaymentOption] = useState<RecommendationType | null>(null);
  const [recommendation, setRecommendation] = useState<RecommendationType>('finance');
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {currentStep === 'form' && <FormPage onSubmit={handleFormSubmit} onBack={handleBackToHome} />}
