...
export default function ResultsPage({ formData, selectedCar, recommendation, onSelectOption, onStartOver }: ResultsPageProps) {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">
            Choose the best way to finance your {selectedCar ? selectedCar.name : 'Toyota'}
          </p>
        </div>
          ...
          {reorderedOptions.map((option, index) => {
            ...
            return (
              <Card
                key={option.type}
                className={`relative ${
                  isRecommended ? 'ring-2 ring-[#d71920] shadow-xl scale-105 z-10' : 'shadow-md'
                } transition-all`}
              >
                {isRecommended && (
                ...
                <CardFooter>
                  <Button
                    ...
                    className={`w-full ${
                      isRecommended ? 'bg-[#d71920] hover:bg-[#a01419] text-white' : ''
                    }`}
                  >
                    Choose {option.title}
                  </Button>
