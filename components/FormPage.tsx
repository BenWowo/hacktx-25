...
import { ArrowLeft, DollarSign, CreditCard, Briefcase, TrendingUp } from 'lucide-react';
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Help us understand your situation to provide the best recommendations
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Monthly Budget */}
            <div className="space-y-2">
              <Label htmlFor="monthlyBudget">Monthly Budget for Car Payment</Label>
              <div className="relative">
                <DollarSign className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                <Input
                  id="monthlyBudget"
